...
void ChunkRenderer::create(int taille,int x,int y, int z) {
...
void ChunkRenderer::create(Chunk* chunk)
{
...
void ChunkRenderer::draw(const glm::mat4& projectionMatrix, const glm::mat4& viewMatrix)
{
	if (active) {
...
std::vector<glm::vec3> ChunkRenderer::getWorld()
{
	return world;
}
